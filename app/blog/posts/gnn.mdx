...
tags: [Deep Learning, GNN, Graph Neural Network, Paper Reading]
---
...
<PaperCard
	...
	links={[
		...
		{ label: "代码实战", url: "https://github.com/yunshenwuchuxun/yunshen-blogv1/blob/main/papers/04-GNN/code.ipynb" },
	]}
/>
